...
- **🧪 Test Generation**: Auto-generates tests for your code
...
```bash
# Python dependencies
cd ..  # Go to hello-world root
pip install fastapi uvicorn pydantic einops
...
- **Squad: Refactor Code**: Intelligent code refactoring
- **Squad: Generate Tests**: Auto-generate unit/integration tests
...
2. **Verify** - Answer + verification loop (recommended, ~600ms)
3. **Research** - Multi-query exploration (~900ms)
4. **Plan & Execute** - Goal decomposition for complex tasks (~750ms)
...
**Server won't start:**
- Check Python dependencies: `pip install fastapi uvicorn pydantic einops`
- Verify you're in the hello-world root for imports
...
**Built with ❤️ using HoloLoom's agentic reasoning system**
