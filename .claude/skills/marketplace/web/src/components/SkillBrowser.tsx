 ...
 * **Updated**: December 3, 2025 - Added onSelectSkill prop for routing
...
export const SkillBrowser: React.FC<SkillBrowserProps> = ({ onSelectSkill }) => {
        ...
        {!isLoading &&
          ...
          skills.map((skill) => (
            <SkillCard
              ...
              onSelect={() => onSelectSkill(skill.skill_id)}
              onInstall={() => {
                queryClient.invalidateQueries({ queryKey: ['skills'] });
              }}
              onUpgrade={() => {
