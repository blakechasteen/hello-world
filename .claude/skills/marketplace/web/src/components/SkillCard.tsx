 ...
 * **Updated**: December 3, 2025 - Added onSelect prop for navigation
...
import { Download, Trash2, RefreshCw, Star, ExternalLink, ChevronRight } from 'lucide-react';
...
export const SkillCard: React.FC<SkillCardProps> = ({
  ...
  return (
    <div className="skill-card">
      <div
        className="skill-card-header clickable"
        onClick={onSelect}
        role="button"
        tabIndex={0}
