...
class RecursiveScratchpad:
    ...
    async def initialize(self) -> None:
        ...
        from hololoom.core.recursive.scratchpad.persistence import ThoughtPersistence
        self._persistence = ThoughtPersistence(self.storage_path)
        await self._persistence.initialize()

        # Lazy load dialogue engine
        from hololoom.core.recursive.scratchpad.internal_dialogue import InternalDialogue
        ...
        from hololoom.core.recursive.scratchpad.strange_loops import LoopDetector
