...
from hololoom.core.orchestrator.weaving_orchestrator import WeavingOrchestrator as BaseOrchestrator

# ToolExecutor was removed during the Elegance Pass refactoring.
# Use the protocol from core.protocols instead.
try:
    from hololoom.core.protocols.shuttle import ToolExecutor as BaseToolExecutor
except ImportError:
    BaseToolExecutor = object  # type: ignore[assignment,misc]
