...
async def search_threads(
    q: str | None = QueryParam(None, description="Search query"),
    agent: str | None = QueryParam(None, description="Filter by agent"),
    from_date: str | None = QueryParam(None, description="From date (ISO format)"),
    to_date: str | None = QueryParam(None, description="To date (ISO format)"),
    bookmarked: bool | None = QueryParam(None, description="Only bookmarked"),
    min_confidence: float | None = QueryParam(None, description="Minimum confidence"),
    has_breakthroughs: bool | None = QueryParam(None, description="Has breakthroughs"),
    user_id: str | None = QueryParam(None, description="Filter by user"),
    tags: str | None = QueryParam(None, description="Filter by tags (comma-separated)")
) -> dict[str, Any]:
    """
...
async def get_bookmarked_threads(user_id: str | None = None):
