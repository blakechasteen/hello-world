...
try:
    from HoloLoom.protocols import ExecutionEngine as CanonicalExecutionEngine
    CANONICAL_AVAILABLE = True
except ImportError:
    CANONICAL_AVAILABLE = False
    CanonicalExecutionEngine = None
...
@runtime_checkable
class _DeprecatedExecutionEngine(Protocol):
    """
    DEPRECATED: This local protocol definition is deprecated.
    Use 'from HoloLoom.protocols import ExecutionEngine' instead.
...
 #   B a c k w a r d   c o m p a t i b i l i t y   a l i a s e s  
 i f   C A N O N I C A L _ A V A I L A B L E   a n d   C a n o n i c a l E x e c u t i o n E n g i n e   i s   n o t   N o n e :  
         E x e c u t i o n E n g i n e   =   C a n o n i c a l E x e c u t i o n E n g i n e  
 e l s e :  
         E x e c u t i o n E n g i n e   =   _ D e p r e c a t e d E x e c u t i o n E n g i n e  
  
 i m p o r t   w a r n i n g s  
 w a r n i n g s . w a r n ( ' L o c a l   E x e c u t i o n E n g i n e   p r o t o c o l   i s   d e p r e c a t e d .   I m p o r t   f r o m   H o l o L o o m . p r o t o c o l s   i n s t e a d ' ,   D e p r e c a t i o n W a r n i n g ,   s t a c k l e v e l = 2 )  
 