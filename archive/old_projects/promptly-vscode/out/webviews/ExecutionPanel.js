...
class ExecutionPanel {
    ...
    static createOrShow(extensionUri, client) {
        ...
        const panel = vscode.window.createWebviewPanel('promptlyExecution', 'Promptly Execution', column || vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async handleGetStatus(executionId) {
        try {
