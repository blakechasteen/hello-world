...
function optimizeContext(codeContext: CodeContext): CodeContext {
...
console.log('\nTest 3: Context Optimization - Large File without Selection');
const largeFileNoSelection: CodeContext = {
    currentFile: largeLines.join('\n'),
    fileName: 'large.ts'
};
