...
# Import types from local types module (no external dependencies)
try:
    from .trough_types import Language, Severity, ErrorCategory, LogicError as LogicErrorData
except ImportError:
...
class LogicErrorType(str, Enum):
    """Types of logic errors detected (legacy - use ErrorCategory instead)."""
...
@dataclass
class LogicError:
    """Represents a detected logic error (legacy format)."""
