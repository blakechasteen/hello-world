...
# Core
from HoloLoom.departments.proto.core import ProtoEngine, ProtoConfig, ProtoMode

# Domain
from HoloLoom.departments.proto.domain import (
    ProtoIntent,
    ProtoAction,
    ProtoResponse,
    CodeContext,
...
# Integration
from HoloLoom.departments.proto.integration import (
    AgenticBridge,
    ProtoReasoningMode,
    AgenticBridgeResult,
    ProtoDepartment,
