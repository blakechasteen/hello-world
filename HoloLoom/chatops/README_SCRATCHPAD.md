...
from HoloLoom.chatops.scratchpad.manager import create_and_start_manager
...
```python
from HoloLoom.chatops.handlers import ConversationHandlers
...
```python
from HoloLoom.chatops.scratchpad import serialize_content, deserialize_content
...
```python
from HoloLoom.chatops.scratchpad.serialization import detect_content_type, ContentType
...
```python
import logging
logging.getLogger("HoloLoom.chatops.scratchpad").setLevel(logging.DEBUG)
```
