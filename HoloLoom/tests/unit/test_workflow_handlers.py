...
class TestWorkflowList:
    ...
    async def test_list_success(self, mock_room, mock_event):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_list

        mock_session = MockClientSession({
            "http://localhost:8001/api/workflow/versions?branch=main": MockResponse(MOCK_WORKFLOW_VERSIONS)
        })

        with patch('HoloLoom.chatops.handlers.workflow_handlers.aiohttp.ClientSession', return_value=mock_session):
...
class TestWorkflowRun:
    ...
    async def test_run_success(self, mock_room, mock_event):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_run
...
class TestWorkflowStatus:
    ...
    async def test_status_healthy(self, mock_room, mock_event):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_status
...
class TestWorkflowValidate:
    ...
    async def test_validate_success(self, mock_room, mock_event):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_validate
...
class TestWorkflowGenerate:
    ...
    async def test_generate_success(self, mock_room, mock_event, mock_generator):
        ...
        from HoloLoom.chatops.handlers import workflow_handlers
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_generate
...
class TestWorkflowAgents:
    ...
    async def test_agents_success(self, mock_room, mock_event):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_agents
...
class TestWorkflowOptimize:
    ...
    async def test_optimize_with_suggestions(self, mock_room, mock_event):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_optimize
...
class TestWorkflowHelp:
    ...
    async def test_help_content(self, mock_room, mock_event):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import handle_workflow_help
...
class TestWorkflowHandlersClass:
    ...
    def test_init_default(self):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import WorkflowHandlers
...
class TestRegistration:
    ...
    def test_register_workflow_handlers(self):
        ...
        from HoloLoom.chatops.handlers.workflow_handlers import register_workflow_handlers
